...
class SeverityAdd extends React.Component {
    ...
    initData = () => {
        ...
        this.data.type.val = 1;
        this.data.severity.val = 1;
        this.data.percentage.val = '';
        this.data.id = null;
        this.data.added_by = null;

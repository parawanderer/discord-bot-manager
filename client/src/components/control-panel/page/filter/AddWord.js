...
class AddWord extends React.Component {
    ...
    validateFormData = () => {
        ...
        // duplicate check...
        if (!errors && this.checkDuplicates(data, raw_type)) {
    ...
    render() {
        ...
        return (
            <EditPopup
                ...
                componentName={"word"}
                confirmText={"Add New"}
                confirmIcon={<i className="fas fa-plus"></i>}
            >
